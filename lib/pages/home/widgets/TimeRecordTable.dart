          ...
          children: [
            Padding(
              ...
              child: Text(
                todayDate,
                style:
                    headingStyle().copyWith(fontSize: 18, color: Colors.black),
              ),
            ),
            const Padding(
            ...
            Container(
              ...
              padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8), // Makes the button take full width
              child: ElevatedButton(
                onPressed: () =>_selectTime(context, true),
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.primaryColor, // Background color
                  padding: const EdgeInsets.symmetric(vertical: 2), // Increase height
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12), // Rounded corners
                  ),
                ),
                child: Text("Record Time",style: TextStyle(color: AppColors.whiteColor)),
              ),
            )
          ],
        ),
